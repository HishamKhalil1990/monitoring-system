...
export default function ConfirmModal({setOpen,sendNotification,closeNotfication,text,textRef,branches,changeAllCheck}){
    return(
        <Popup
        ...
        >
            ...
            <div className={styles.modal}>
                ...
                <button 
                    ...
                    onClick={() => {closeNotfication();setOpen(false);close();sendNotification(text,branches);changeAllCheck('الغاء')}}
                > 
                    Confirm 
                </button>
                <button
